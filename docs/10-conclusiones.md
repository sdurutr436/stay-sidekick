...
- Pruebas backend: 499/499 correctas (cobertura 92 %, umbral mínimo 90 %).
- Pruebas frontend: 297/297 correctas (cobertura ≥ 90 %).
...
| Testing automatizado real | ✅ Cumplido | 796 tests totales (499 backend + 297 frontend) con cobertura ≥ 90 % en ambas capas |
